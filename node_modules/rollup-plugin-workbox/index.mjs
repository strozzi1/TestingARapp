 ...
 * @property {string} [importWorkboxFrom] - Valid values are 'cdn', 'local', and 'disabled.
 ...
 * @property {Object[]} [navigateFallbackBlacklist] - An optional array of regular expressions that restricts which URLs the configured navigateFallback behavior applies to.
 * @property {Object[]} [navigateFallbackWhitelist] - An optional array of regular expressions that restricts which URLs the configured navigateFallback behavior applies to.
